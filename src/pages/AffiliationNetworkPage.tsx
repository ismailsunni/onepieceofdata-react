...
function AffiliationNetworkPage() {
    ...
    <main className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <nav className="flex items-center gap-2 text-sm text-gray-500 mb-6">
          ...
          <ChevronRight />
          <span className="text-gray-900 font-medium">Affiliation Network</span>
        </nav>
        ...
        <div className="mb-6">
          ...
          <p className="text-lg text-gray-600">
            Groups connected by shared members. Thicker edges = more members in
            common.
          </p>
        </div>
...
export default AffiliationNetworkPage
