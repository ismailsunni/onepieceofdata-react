    ...
    <main className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <nav className="flex items-center gap-2 text-sm text-gray-500 mb-6">
          ...
          <span className="text-gray-900 font-medium">Sagas</span>
        </nav>

        {/* Page Header */}
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-3">Sagas</h1>
        ...
        <div className="mb-6">
          <div className="relative max-w-md">
            ...
            <input
              type="search"
              aria-label="Search sagas by name"
              placeholder="Search sagas by name…"
              value={globalFilter}
        ...
        {isError ? (
          <ErrorState
            message="Failed to load sagas. Please try again."
            onRetry={() => refetch()}
          />
        ) : isLoading ? (
