        ...
        <div className="bg-white rounded-lg shadow-md p-6 md:p-8 space-y-6">
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              One Piece of Data is a comprehensive data exploration platform
          ...
          <section>
            ...
            <div className="space-y-3 text-gray-700">
              ...
              <div>
                ...
                <p className="ml-2">
                  The One Piece community for their continued support and
                  passion
                </p>
              </div>
            </div>
          ...
          <section className="border-t pt-6">
            ...
            <div className="space-y-3 text-gray-600 text-sm leading-relaxed">
              <p>
                <strong>Fan Project:</strong> One Piece of Data is a fan-made
                project and is not affiliated with, endorsed by, or connected to
                Eiichiro Oda, Shueisha, Toei Animation, or any official One
                Piece entities. All One Piece characters, stories, and related
                content are the property of their respective owners. This
                website is created purely for educational and informational
                purposes for fans of the series.
              </p>
              <p>
                <strong>Data Accuracy:</strong> While we strive for accuracy,
                the data presented on this website may contain errors or
                omissions. One Piece is an ongoing manga series with over 1000
                chapters, and keeping track of all character appearances, story
                arcs, and details is challenging. The data should be used for
                reference and entertainment purposes only. Please verify
