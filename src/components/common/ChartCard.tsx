...
export function ChartCard({
  ...
  return (
    <div className={`bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow relative ${className}`}>
      {/* Header */}
      <div className="mb-4">
        ...
        {filters && <div className="mt-3 pt-3 border-t border-gray-200">{filters}</div>}
      </div>
