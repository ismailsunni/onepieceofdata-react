          ...
          <div className="flex flex-col md:flex-row items-stretch md:items-center gap-4 w-full md:w-auto">
            ...
            <div className="flex items-center gap-4">
              ...
              <a
                ...
                className="hidden lg:inline-flex items-center gap-2 bg-blue-500 hover:bg-blue-400 text-white px-4 py-2 rounded-lg transition-colors duration-300 text-sm whitespace-nowrap"
