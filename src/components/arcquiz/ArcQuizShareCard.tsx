...
interface ArcQuizShareCardProps {
  format: ShareFormat
...
const ArcQuizShareCard = forwardRef<HTMLDivElement, ArcQuizShareCardProps>(
  ({ format, answers, totalScore, rating, modeLabel, logoUrl }, ref) => {
...
ArcQuizShareCard.displayName = 'ArcQuizShareCard'

export default ArcQuizShareCard
